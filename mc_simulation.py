#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Cybercrime & Ransomware / Attribution Impossibility
===================================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Cybercrime & Ransomware (Attribution Impossibility).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "cybercrime",
    "domain_name": "Cybercrime & Ransomware",
    "theorem": "Attribution Impossibility",
    "classification": "Class 1 \u2014 Impossibility",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 1000.0,
    "channels": {
        "C1_financial_extraction": {
            ...
            "high": 120,
            "weight": 0.01,
            "description": "$60B/yr deadweight loss from direct financial extraction (Anderson et al. 2013 DWL fraction 15-25% of gross; excludes wealth transfers). Paper \u00a74 C1: \u03b4_C1=60B [30,90]."
        },
        "C2_business_downtime": {
            ...
            "high": 2200,
            "weight": 0.25,
            "description": "$1,500B/yr business disruption, remediation, recovery costs. Paper \u00a74 C2."
        },
        "C3_ip_theft": {
            "dist": "lognormal",
            "low": 1200,
            ...
            "high": 4500,
            "weight": 0.38,
            "description": "$2,400B/yr IP theft + innovation disincentive multiplier (Commission on Theft of American IP range scaled globally). Paper \u00a74 C3: \u03b4_C3=2,400B [1,000-4,000]. Largest channel."
        },
        "C4_infrastructure": {
            "dist": "lognormal",
            "low": 500,
            ...
            "high": 1800,
            "weight": 0.16,
            "description": "$1,000B/yr critical infrastructure risk, national security costs. Paper \u00a74 C4."
        },
        "C5_consumer_harm": {
            "dist": "lognormal",
            "low": 450,
            ...
            "high": 1600,
            "weight": 0.14,
            "description": "$900B/yr consumer + psychological harm: direct fraud ($150-250B), remediation ($50-100B), QALY-monetized psych harm ($125B), digital participation chilling effect ($100-300B). Paper \u00a74 C5: \u03b4_C5=900B [400-1,500]."
        },
        "C6_governance": {
            "dist": "lognormal",
            "low": 80,
            ...
            "high": 400,
            "weight": 0.03,
            "description": "$200B/yr attribution impossibility, regulatory failure, cross-jurisdictional enforcement costs. Paper \u00a74 C6: \u03b4_C6\u2248140-260B."
        }
    },
    "impossibility_floor": 2.1
}
